...
#define LAVA_KEYWORDS(e)                                                       \
  e(Struct, "struct") e(Enum, "enum") e(TypeDef, "typedef") e(If, "if")        \
      e(Else, "else") e(While, "while") e(SizeOf, "sizeof") e(Break, "break")  \
          e(Continue, "continue") e(Return, "return") e(Void, "void")          \
              e(Unsigned, "unsigned") e(Int, "int") e(Bool, "bool")            \
                  e(Char, "char") e(Const, "const")

// all supported operators
#define LAVA_OPERATORS(e)                                                      \
  e(Add, "+", 90) e(Sub, "-", 90) e(Mul, "*", 100) e(SDiv, "/", 100)           \
      e(SRem, "%", 100) e(Equal, "==", 60) e(NotEqual, "!=", 60)               \
          e(SLess, "<", 70) e(SLessEq, "<=", 70) e(SGreat, ">", 70) e(         \
              SGreatEq, ">=", 70) e(LAnd, "&&", 20) e(LOr, "||", 10)           \
              e(LNot, "!", -1) e(And, "&", 50) e(Or, "|", 30) e(Not, "~", -1)  \
                  e(Xor, "^", 40) e(Shl, "<<", 80) e(LShr, ">>", 80)           \
                      e(Access, ".", -1) e(Arrow, "->", -1) e(Assign, "=", 0)  \
                          e(AssAdd, "+=", 0) e(AssSub, "-=", 0)                \
                              e(AssMul, "*=", 0) e(AssSDiv, "/=", 0)           \
                                  e(AssSRem, "%=", 0) e(AssAnd, "&=", 0)       \
                                      e(AssOr, "|=", 0) e(AssXor, "^=", 0)     \
                                          e(AssShl, "<<=", 0)                  \
                                              e(AssLShr, ">>=", 0)
