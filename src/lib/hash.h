...
void decoding(vector<int> op, std::ostream &os) {
...
void hash(std::ostream &os) {
  vector<int> output_code = {109, 101, 100, 105, 97, 110, 58, 10, 32, 264, 265, 264, 112, 117, 115, 104, 266, 123, 114,
